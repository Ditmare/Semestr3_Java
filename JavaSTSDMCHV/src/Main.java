    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            String createSalesTable = "CREATE TABLE IF NOT EXISTS sales " +
                    "(id INT PRIMARY KEY AUTO_INCREMENT, car_id INT, customer_name VARCHAR(255), age INT, gender VARCHAR(10), price DOUBLE, " +
                    "FOREIGN KEY (car_id) REFERENCES cars(id), " +
                    "FOREIGN KEY (customer_name) REFERENCES customers(customer_name))"; // Добавлен внешний ключ для customer_name
